...
export default {
  ...
  components: {
    Border: () => import('../../Template/Border.vue'),
    Decoration: () => import('../../Template/Decoration.vue'),
    Multiline: () => import('../../Template/Multiline.vue'),
    DetailTable: () => import('../../Template/DetailTable.vue'),
    DigitalFlop: () => import('../../Template/DigitalFlop.vue'),
    ScrollBoard: () => import('../../Template/ScrollBoard.vue'),
    ScrollRankingBoard: () => import('../../Template/ScrollRankingBoard.vue'),
    CustomEntry: () => import('../../Template/CustomEntry.vue')
  },
  data () {
    return {
